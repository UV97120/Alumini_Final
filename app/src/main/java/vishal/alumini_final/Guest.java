...
public class Guest extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
/*-------------Drawer-----------------*/
        ...
        toggle.syncState();
/*-----------right Drawer--------------*/
        NavigationView leftnavigationView = (NavigationView) findViewById(R.id.left_guest_nav_view);
